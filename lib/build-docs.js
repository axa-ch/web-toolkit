...
metalsmith.use(
  ...
  .use(layouts({
    engine: 'handlebars',
    directory: path.join(cwd, './hbs-partials'),
  }))
)
metalsmith.use(log('Wrapped handlebars demos with their layouts.'))
...
metalsmith.use(log('Wrapped other pages with their layouts.'))
